...
document.getElementById('reg').addEventListener("change", function () {
    ...
    rec3.onreadystatechange = function () {
        ...
        if (rec3.readyState == 4 && rec3.status == 200) {
            ...
            document.getElementById('hora').innerHTML = `<table style="text-align:center; justify-content:center; margin-left: 100px; "><thead><tr><td>${local}</td></thead></tr> <tr><td id="tempo"> </td></tr> <tr><td>${fuzo}</td></tr></table>`
